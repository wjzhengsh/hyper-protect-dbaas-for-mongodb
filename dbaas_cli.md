...
Use the {{site.data.keyword.cloud}} {{site.data.keyword.ihsdbaas_mongodb_full}} CLI plug-in to create, delete,
...
- *auth_db.username*
  ...
  The [authentication database](https://docs.mongodb.com/manual/core/security-users/#user-authentication-database){: external} name and user name, separated by a period, to be assigned to the database user being created.
...
- *auth_db.username*
  ...
  The authentication database name and user name, separated by a period, of the database user being deleted.
