...
| *hyperp-dbaas-mongodb* |{{site.data.keyword.ihsdbaas_mongodb_full}} 的型錄名稱。|
| *mongodb-small*  |方案名稱。可用方案為：**mongodb-small**、**mongodb-medium** 和 **mongodb-large**。（**附註：**方案名稱會區分大小寫。）|
| *us-south*            |新資料庫將位於的位置。（**附註：**目前，僅 **us-south** 支援 {{site.data.keyword.ihsdbaas_mongodb_full}}。）|
...
<table>
  ...
  <tr>
    <td>*license_agree*</td>
    <td>值為 **agreed** 指出接受授權合約，這樣才能使用 {{site.data.keyword.ihsdbaas_mongodb_full}}。</td>
  </tr>
</table>
