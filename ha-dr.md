...
{{site.data.keyword.cloud_notm}} {{site.data.keyword.ihsdbaas_mongodb_full}} is a GA service that is offered in Dallas, Frankfurt, and Sydney. Each supported region has three different data centers for redundancy.
{: shortdesc}
